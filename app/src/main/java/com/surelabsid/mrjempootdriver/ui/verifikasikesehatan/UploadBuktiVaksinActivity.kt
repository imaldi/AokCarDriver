...
import com.surelabsid.mrjempootdriver.databinding.ActivityUploadBuktiVaksinBinding
...
@AndroidEntryPoint
class UploadBuktiVaksinActivity : BaseActivity() {

    private lateinit var binding: ActivityUploadBuktiVaksinBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUploadBuktiVaksinBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.toolbar.title.text = "Upload Bukti Vaksin"
    ...
    private fun initView() {
        ...
        binding.buttonSelanjutnya.setOnClickListener {
            ...
            intent.putExtra("document_vaksin", image_path)
            setResult(DOCUMENT_VAKSIN_RESULT, intent)
            finish()
        }
    }
    ...
    private fun initCamera(data: Intent?) {
        try {
            ...
            name_file = "DocumentVaksin$random"
